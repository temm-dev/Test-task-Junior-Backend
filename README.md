...
- **POST /api/sync/** — загружает все медиа-объекты пользователя из Instagram (с обработкой пагинации) и сохраняет/обновляет.
- **GET /api/posts/** — возвращает список сохранённых постов с пагинацией.
