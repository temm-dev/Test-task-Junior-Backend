...
P.s. - Изначально не был знаком с Django, но мне было интересно выполнить задание. Использовал deepseek для базовой структуры и объяснения концепций. Разобрал каждый кусок кода, адаптировал решение под требования и полностью понимаю(наверное), как работает каждая часть проекта. Желаю пройти тестовое задание и показать свою способность к обучению